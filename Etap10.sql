...
--Eksperyment 1
ALTER TABLE Loans MOVE NOCOMPRESS;

ALTER TABLE Loans MOVE COMPRESS FOR ALL OPERATIONS;

ALTER TABLE Loans INMEMORY MEMCOMPRESS FOR QUERY LOW;

ALTER TABLE Loans INMEMORY MEMCOMPRESS FOR QUERY HIGH;

ALTER TABLE Loans INMEMORY MEMCOMPRESS FOR CAPACITY LOW;

ALTER TABLE Loans INMEMORY MEMCOMPRESS FOR CAPACITY HIGH;
